...
Cohesion: 0.16
Nodes (17): IReadOnlyList, SaleEndpoints, CreateSaleRequest, PaymentDto, RegisterPaymentRequest, SaleDto, SaleItemDto, SaleItemRequest (+9 more)
...
Cohesion: 0.17
Nodes (17): AbstractValidator, ProductEndpoints, DescriptionRequestValidator, NameRequestValidator, SupplierRequestValidator, ClientRequestValidator, PriceSuggestionDto, ProductDto (+9 more)
...
Cohesion: 0.43
Nodes (6): DateOnly, DateTimeOffset, List, Payment, Sale, SaleConfiguration
...
Cohesion: 0.19
Nodes (8): InlineData, DateOnly, DateTimeOffset, Fact, OrderTests, ProductTests, SaleTests, Theory
...
### Community 28 - "IAppDbContext & Sale Entity"
Cohesion: 0.33
Nodes (5): CancellationToken, DbSet, Func, Task, IAppDbContext
...
## Knowledge Gaps
- **68 isolated node(s):** `net10.0`, `Microsoft.AspNetCore.Authentication.JwtBearer (10.0.10)`, `Microsoft.AspNetCore.OpenApi (10.0.10)`, `Microsoft.EntityFrameworkCore.Design (10.0.10)`, `Microsoft.OpenApi (2.11.0)` (+63 more)
...
- **Why does `NsStore.Domain.Enums` connect `Domain Entities & Core Services Hub` to `Auth & JWT Tokens`, `User Management & Password Hashing`, `Sale Service & DTOs`, `Order Service & Policies`, `Purchase Service & DTOs`, `FluentValidation Validators`, `Client Service & DTOs`, `Domain Enums & Purchase Entity`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `NsStore.Domain.Entities` connect `Domain Entities & Core Services Hub` to `Catalog & Inventory Services`, `Auth & JWT Tokens`, `Settings & Reports Services`, `User Management & Password Hashing`, `Catalog Entities & EF Configurations`, `Transaction EF Configurations`, `Current User & Identity/Refresh Tokens`, `Inventory/Product Entities & EF Configs`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `NsStore.Domain.Common` connect `Domain Entities & Core Services Hub` to `Catalog Entities & EF Configurations`, `Application/Domain Exceptions`?**
