...
namespace NsStore.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260803160851_AddSerializedInventory")]
    partial class AddSerializedInventory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "product_serial_status", new[] { "in_stock", "removed", "sold" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "serial_event_type", new[] { "received", "registered", "removed", "sold", "transferred_in", "transferred_out" });
            ...
            modelBuilder.Entity("NsStore.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasIndex("ReceiptId")
                        .HasDatabaseName("ix_payments_receipt_id");
            ...
            modelBuilder.Entity("NsStore.Domain.Entities.PaymentReceipt", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("Number")
                        .IsUnique()
                        .HasDatabaseName("ix_payment_receipts_number");

                    b.HasIndex("BranchId", "BranchSequence")
                        .IsUnique()
                        .HasDatabaseName("ix_payment_receipts_branch_id_branch_sequence");

                    b.HasIndex("ClientId", "ReceiptDate")
                        .HasDatabaseName("ix_payment_receipts_client_id_receipt_date");

                    b.ToTable("payment_receipts", null, t =>
                        {
                            t.HasCheckConstraint("ck_payment_receipts_total_positive", "total_amount > 0");
                        });
                });
            ...
            modelBuilder.Entity("NsStore.Domain.Entities.ProductSerial", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<ProductSerialStatus>("Status")
                        .HasColumnType("product_serial_status")
                        .HasColumnName("status");
                    ...
                    b.HasIndex("BranchId")
                        .HasDatabaseName("ix_product_serials_branch_id");

                    b.HasIndex("PurchaseItemId")
                        .HasDatabaseName("ix_product_serials_purchase_item_id");

                    b.HasIndex("SaleItemId")
                        .HasDatabaseName("ix_product_serials_sale_item_id");

                    b.HasIndex("SerialNumber")
                        .IsUnique()
                        .HasDatabaseName("ix_product_serials_serial_number");

                    b.HasIndex("ProductId", "BranchId", "Status")
                        .HasDatabaseName("ix_product_serials_product_id_branch_id_status");

                    b.ToTable("product_serials", (string)null);
                });

            modelBuilder.Entity("NsStore.Domain.Entities.ProductSerialEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<SerialEventType>("EventType")
                        .HasColumnType("serial_event_type")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_serial_events");

                    b.HasIndex("BranchId")
                        .HasDatabaseName("ix_product_serial_events_branch_id");

                    b.HasIndex("ReferenceType", "ReferenceId")
                        .HasDatabaseName("ix_product_serial_events_reference_type_reference_id");

                    b.HasIndex("SerialId", "CreatedAt")
                        .HasDatabaseName("ix_product_serial_events_serial_id_created_at");

                    b.ToTable("product_serial_events", (string)null);
                });
            ...
            modelBuilder.Entity("NsStore.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("NsStore.Domain.Entities.PaymentReceipt", "Receipt")
                        .WithMany("Payments")
                        .HasForeignKey("ReceiptId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_payments_payment_receipts_receipt_id");
            ...
            modelBuilder.Entity("NsStore.Domain.Entities.PaymentReceipt", b =>
                {
                    b.HasOne("NsStore.Domain.Entities.Branch", "Branch")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_payment_receipts_branches_branch_id");
                    ...
                    b.HasOne("NsStore.Domain.Entities.Client", "Client")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_payment_receipts_clients_client_id");
            ...
            modelBuilder.Entity("NsStore.Domain.Entities.ProductSerial", b =>
                {
                    b.HasOne("NsStore.Domain.Entities.Branch", "Branch")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_product_serials_branches_branch_id");
                    ...
                    b.HasOne("NsStore.Domain.Entities.PurchaseItem", "PurchaseItem")
                        .WithMany("Serials")
                        .HasForeignKey("PurchaseItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_product_serials_purchase_items_purchase_item_id");

                    b.HasOne("NsStore.Domain.Entities.SaleItem", "SaleItem")
                        .WithMany("Serials")
                        .HasForeignKey("SaleItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_product_serials_sale_items_sale_item_id");
            ...
            modelBuilder.Entity("NsStore.Domain.Entities.ProductSerialEvent", b =>
                {
                    b.HasOne("NsStore.Domain.Entities.Branch", "Branch")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_product_serial_events_branches_branch_id");

                    b.HasOne("NsStore.Domain.Entities.ProductSerial", "Serial")
                        .WithMany("Events")
                        .HasForeignKey("SerialId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_serial_events_product_serials_serial_id");
